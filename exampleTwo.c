...
// functionsPtr - points to a comparison function below and will
...
// The functionPtr will point to one of these
// comparison functions to perform a check
static int compareEmployeeNumber(const void *targetPtr,
...
static int compareEmployeeName(const void *targetPtr,
                               PtrToConstEmployee tableValuePtr)
{
  // const void *targetPtr -> typecast as char pointer then pass to strcmp()
